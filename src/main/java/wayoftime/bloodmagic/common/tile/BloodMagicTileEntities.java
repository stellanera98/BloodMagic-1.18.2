...
public class BloodMagicTileEntities
{
	...
	public static final RegistryObject<BlockEntityType<TileBloodTank>> BLOOD_TANK_TYPE = TILE_ENTITIES.register("bloodtank", () -> BlockEntityType.Builder.of(TileBloodTank::new, BloodMagicBlocks.BLOOD_TANK1.get(), BloodMagicBlocks.BLOOD_TANK2.get(), BloodMagicBlocks.BLOOD_TANK3.get(), BloodMagicBlocks.BLOOD_TANK4.get(), BloodMagicBlocks.BLOOD_TANK5.get(), BloodMagicBlocks.BLOOD_TANK6.get(), BloodMagicBlocks.BLOOD_TANK7.get(), BloodMagicBlocks.BLOOD_TANK8.get(), BloodMagicBlocks.BLOOD_TANK9.get(), BloodMagicBlocks.BLOOD_TANK10.get(), BloodMagicBlocks.BLOOD_TANK11.get(), BloodMagicBlocks.BLOOD_TANK12.get(), BloodMagicBlocks.BLOOD_TANK13.get(), BloodMagicBlocks.BLOOD_TANK14.get(), BloodMagicBlocks.BLOOD_TANK15.get(), BloodMagicBlocks.BLOOD_TANK16.get()).build(null));
