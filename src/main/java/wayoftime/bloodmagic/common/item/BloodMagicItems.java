...
import wayoftime.bloodmagic.common.item.routing.ItemFluidFilter;
...
//	public static final RegistryObject<Item> WEAK_BLOOD_ORB = BASICITEMS.register("weakbloodorb", () -> new ItemBloodOrb(WEAK_ORB_INSTANCE));
	...
	public static final RegistryObject<Item> ITEM_FLUID_ROUTER_FILTER = BASICITEMS.register("itemfluidrouterfilterexact", ItemFluidFilter::new);
