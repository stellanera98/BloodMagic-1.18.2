...
public class GeneratorBlockTags extends BlockTagsProvider
{
	...
	public void addTags()
	{
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BloodMagicBlocks.BLOOD_TANK1.get()).add(BloodMagicBlocks.BLOOD_TANK2.get()).add(BloodMagicBlocks.BLOOD_TANK3.get()).add(BloodMagicBlocks.BLOOD_TANK4.get()).add(BloodMagicBlocks.BLOOD_TANK5.get()).add(BloodMagicBlocks.BLOOD_TANK6.get()).add(BloodMagicBlocks.BLOOD_TANK7.get()).add(BloodMagicBlocks.BLOOD_TANK8.get()).add(BloodMagicBlocks.BLOOD_TANK9.get()).add(BloodMagicBlocks.BLOOD_TANK10.get()).add(BloodMagicBlocks.BLOOD_TANK11.get()).add(BloodMagicBlocks.BLOOD_TANK12.get()).add(BloodMagicBlocks.BLOOD_TANK13.get()).add(BloodMagicBlocks.BLOOD_TANK14.get()).add(BloodMagicBlocks.BLOOD_TANK15.get()).add(BloodMagicBlocks.BLOOD_TANK16.get());
        ...
        tag(BlockTags.NEEDS_STONE_TOOL).add(BloodMagicBlocks.BLOOD_TANK1.get()).add(BloodMagicBlocks.BLOOD_TANK2.get()).add(BloodMagicBlocks.BLOOD_TANK3.get()).add(BloodMagicBlocks.BLOOD_TANK4.get()).add(BloodMagicBlocks.BLOOD_TANK5.get()).add(BloodMagicBlocks.BLOOD_TANK6.get()).add(BloodMagicBlocks.BLOOD_TANK7.get()).add(BloodMagicBlocks.BLOOD_TANK8.get()).add(BloodMagicBlocks.BLOOD_TANK9.get()).add(BloodMagicBlocks.BLOOD_TANK10.get()).add(BloodMagicBlocks.BLOOD_TANK11.get()).add(BloodMagicBlocks.BLOOD_TANK12.get()).add(BloodMagicBlocks.BLOOD_TANK13.get()).add(BloodMagicBlocks.BLOOD_TANK14.get()).add(BloodMagicBlocks.BLOOD_TANK15.get()).add(BloodMagicBlocks.BLOOD_TANK16.get());
