...
//				+ "airsigil"));
		...
		AlchemyArrayRecipeBuilder.array(BloodMagic.rl("textures/models/alchemyarrays/voidsigil.png"), Ingredient.of(BloodMagicItems.REAGENT_HARVEST.get()), Ingredient.of(BloodMagicItems.DEMONIC_SLATE.get()), new ItemStack(BloodMagicItems.HARVEST_GODDESS_SIGIL.get())).build(consumer, BloodMagic.rl(basePath + "harvestgoddesssigil"));
		...
		AlchemyArrayRecipeBuilder.array(AlchemyArrayRegistry.BINDING_ARRAY, Ingredient.of(BloodMagicItems.REAGENT_BINDING.get()), Ingredient.of(BloodMagicItems.AIR_INSCRIPTION_TOOL.get()), new ItemStack(BloodMagicItems.BOUND_AIR_INSCRIPTION_TOOL.get())).build(consumer, BloodMagic.rl(basePath + "bound_air_inscription_tool"));
		AlchemyArrayRecipeBuilder.array(AlchemyArrayRegistry.BINDING_ARRAY, Ingredient.of(BloodMagicItems.REAGENT_BINDING.get()), Ingredient.of(BloodMagicItems.EARTH_INSCRIPTION_TOOL.get()), new ItemStack(BloodMagicItems.BOUND_EARTH_INSCRIPTION_TOOL.get())).build(consumer, BloodMagic.rl(basePath + "bound_earth_inscription_tool"));
		AlchemyArrayRecipeBuilder.array(AlchemyArrayRegistry.BINDING_ARRAY, Ingredient.of(BloodMagicItems.REAGENT_BINDING.get()), Ingredient.of(BloodMagicItems.WATER_INSCRIPTION_TOOL.get()), new ItemStack(BloodMagicItems.BOUND_WATER_INSCRIPTION_TOOL.get())).build(consumer, BloodMagic.rl(basePath + "bound_water_inscription_tool"));
		AlchemyArrayRecipeBuilder.array(AlchemyArrayRegistry.BINDING_ARRAY, Ingredient.of(BloodMagicItems.REAGENT_BINDING.get()), Ingredient.of(BloodMagicItems.FIRE_INSCRIPTION_TOOL.get()), new ItemStack(BloodMagicItems.BOUND_FIRE_INSCRIPTION_TOOL.get())).build(consumer, BloodMagic.rl(basePath + "bound_fire_inscription_tool"));
		AlchemyArrayRecipeBuilder.array(AlchemyArrayRegistry.BINDING_ARRAY, Ingredient.of(BloodMagicItems.REAGENT_BINDING.get()), Ingredient.of(BloodMagicItems.DUSK_INSCRIPTION_TOOL.get()), new ItemStack(BloodMagicItems.BOUND_DUSK_INSCRIPTION_TOOL.get())).build(consumer, BloodMagic.rl(basePath + "bound_dusk_inscription_tool"));
